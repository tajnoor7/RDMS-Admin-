...
$sql = "INSERT INTO train (train_id, train_name, departure_from, arrival_to, departure_time, arrival_time) VALUES 
('$train_id', '$train_name', '$departure_from', '$arrival_to' ,'$departure_time','$arrival_time')";
...
<body>
     ...
     <<header>
     <div>
        <h1 style="font-size:70px;font-display: block;"><font color="yellow"><center> Train Information Inserted Successfuly</center> </font> </h1>
      </div>  
      </header>
